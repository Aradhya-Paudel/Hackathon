                ...
                return (
                  <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <p className="text-sm text-[#4A4A4A] mb-6 italic">
                      Nepal Government Process - {application.service_type?.replace('-', ' ').toUpperCase() || 'Application'}
                    </p>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute top-14 left-0 right-0 h-1 bg-[#E0E0E0]">
                          <div 
                            ...
                            style={{ width: `${(currentStageIndex / (flowchartStages.length - 1)) * 100}%` }}
                          ></div>
                        </div>

                        {/* Stages - Fixed grid based on number of stages */}
                        <div className={`relative grid gap-4`} style={{ gridTemplateColumns: `repeat(${flowchartStages.length}, 1fr)` }}>
                          {flowchartStages.map((stage, index) => {
                            ...
                            return (
                              <div key={stage.id} className="flex flex-col items-center text-center">
                                ...
                                <p className="text-xs text-[#4A4A4A] mb-1">{stage.description}</p>
